...
const INITIAL_DB = {
  ...
  menus: {
    ...
    r3: [
      { id:"r3m1",  name:"Taboulée",              cat:"Mezze",     price:10.0, prep:5,  emoji:"🥗", img:"https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=200&h=200&fit=crop" },
      { id:"r3m2",  name:"Kébbé Nayé",            cat:"Mezze",     price:10.0, prep:5,  emoji:"🥩", img:"https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=200&h=200&fit=crop" },
      { id:"r3m3",  name:"Salade Fatouch",         cat:"Mezze",     price:10.0, prep:5,  emoji:"🥗", img:"https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=200&h=200&fit=crop" },
      ...
      { id:"r3m5",  name:"Moutabal",               cat:"Mezze",     price:7.0,  prep:5,  emoji:"🍆", img:"https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=200&h=200&fit=crop" },
      ...
      { id:"r3m10", name:"Baba Ghanouj",           cat:"Mezze",     price:7.0,  prep:5,  emoji:"🍆", img:"https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?w=200&h=200&fit=crop" },
      ...
      { id:"r3m12", name:"Mojadara",               cat:"Mezze",     price:7.0,  prep:8,  emoji:"🌾", img:"https://images.unsplash.com/photo-1535400255456-984b6e9b5cf8?w=200&h=200&fit=crop" },
      ...
      { id:"r3m16", name:"Falafel",                cat:"Mezze",     price:7.0,  prep:10, emoji:"🧆", img:"https://images.unsplash.com/photo-1547592180-85f173990554?w=200&h=200&fit=crop" },
      ...
      { id:"r3m18", name:"Falafel Plat",           cat:"Mezze",     price:14.0, prep:15, emoji:"🧆", img:"https://images.unsplash.com/photo-1593001872095-7d5b3868fb1d?w=200&h=200&fit=crop" },
      ...
      { id:"r3m22", name:"Frrouj Mechwi",          cat:"Grillades", price:18.0, prep:30, emoji:"🍗", img:"https://images.unsplash.com/photo-1604503468506-a8da13d11d36?w=200&h=200&fit=crop" },
      { id:"r3m23", name:"Plat de Paille",         cat:"Grillades", price:18.0, prep:20, emoji:"🥩", img:"https://images.unsplash.com/photo-1544025162-d76694265947?w=200&h=200&fit=crop" },
      ...
      { id:"r3m28", name:"Brochettes Mixte",       cat:"Grillades", price:18.0, prep:20, emoji:"🍢", img:"https://images.unsplash.com/photo-1544025162-d76694265947?w=200&h=200&fit=crop" },
      ...
      { id:"r3m31", name:"Menu Duo Spécial",       cat:"Menus",     price:69.0, prep:35, emoji:"🍽️", img:"https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=200&h=200&fit=crop" },
      { id:"r3m32", name:"Menu Spécial Layali Cham", cat:"Menus",   price:99.0, prep:40, emoji:"👑", img:"https://images.unsplash.com/photo-1544025162-d76694265947?w=200&h=200&fit=crop" },
      ...
      { id:"r3m34", name:"Maria",                  cat:"Sandwichs", price:12.0, prep:10, emoji:"🫓", img:"https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=200&h=200&fit=crop" },
      { id:"r3m35", name:"Durum Falafel",          cat:"Sandwichs", price:9.0,  prep:8,  emoji:"🌯", img:"https://images.unsplash.com/photo-1547592180-85f173990554?w=200&h=200&fit=crop" },
      { id:"r3m36", name:"Durum Poulet",           cat:"Sandwichs", price:9.0,  prep:8,  emoji:"🌯", img:"https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200&h=200&fit=crop" },
      { id:"r3m37", name:"Durum Kefta",            cat:"Sandwichs", price:9.0,  prep:8,  emoji:"🌯", img:"https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200&h=200&fit=crop" },
      { id:"r3m38", name:"Durum Viande",           cat:"Sandwichs", price:9.0,  prep:8,  emoji:"🌯", img:"https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200&h=200&fit=crop" },
      { id:"r3m39", name:"Durum Foie",             cat:"Sandwichs", price:9.0,  prep:8,  emoji:"🌯", img:"https://images.unsplash.com/photo-1565299507177-b0ac66763828?w=200&h=200&fit=crop" },
      { id:"r3m40", name:"Menu Enfants",           cat:"Menus",     price:9.0,  prep:15, emoji:"👶", img:"https://images.unsplash.com/photo-1562802378-063ec186a863?w=200&h=200&fit=crop" },
      { id:"r3m41", name:"Théière petite",         cat:"Boissons",  price:2.5,  prep:3,  emoji:"🍵", img:"https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=200&h=200&fit=crop" },
      { id:"r3m42", name:"Théière moyenne",        cat:"Boissons",  price:3.5,  prep:3,  emoji:"🍵", img:"https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=200&h=200&fit=crop" },
      { id:"r3m43", name:"Théière grande",         cat:"Boissons",  price:5.0,  prep:3,  emoji:"🍵", img:"https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=200&h=200&fit=crop" },
      { id:"r3m44", name:"Latte",                  cat:"Boissons",  price:2.8,  prep:3,  emoji:"☕", img:"https://images.unsplash.com/photo-1541167760496-1628856ab772?w=200&h=200&fit=crop" },
      { id:"r3m45", name:"Café",                   cat:"Boissons",  price:2.0,  prep:2,  emoji:"☕", img:"https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=200&h=200&fit=crop" },
      { id:"r3m46", name:"Aich Saraya",            cat:"Boissons",  price:2.0,  prep:3,  emoji:"🍮", img:"https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=200&h=200&fit=crop" },
      { id:"r3m47", name:"Boisson froide",         cat:"Boissons",  price:2.0,  prep:1,  emoji:"🥤", img:"https://images.unsplash.com/photo-1543253687-c931c8e01820?w=200&h=200&fit=crop" },
    ]
  },
  orders: [],
  needs: [],
