...
// We store the entire app state in ONE Firestore document: restau-pro/state
// This avoids complex collection management and works great for small data.

const STATE_DOC = "restau-pro/state";
